 ...
 * @section DESCRIPTION
 * 
 * Header file for Naviagting muksy robots to different goal positions in the predefined map.
 */
...
class MuskyNavGoal {
 private:
  ...
  tf2::Quaternion my_quat_from_euler;  /// ROS tf2 transform for converting the RPY to 
